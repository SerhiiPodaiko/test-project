...
const usersSlice = createSlice({
    ...
    extraReducers: builder => {
        ...
        builder
            .addCase(fetchGetAllUsers.fulfilled, (state, action: PayloadAction<User[]>) => {
                state.users = action.payload
                state.loading = false
            });
        builder
            .addCase(fetchGetAllUsers.rejected, (state, action: PayloadAction<any>) => {
