...
const useUsersContainer = () => {
    ...
    const renderViewMode = viewMode === "row" ?
        <FormatListBulletedOutlinedIcon fontSize="large" onClick={() => setViewMode("table")} /> :
    <GridViewOutlinedIcon fontSize="large" onClick={() => setViewMode("row")} />
